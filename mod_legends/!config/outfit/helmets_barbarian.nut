...
::Const.LegendMod.HelmObjs.push(::Legends.Helmet.Barbarian.leather_helmet);

::Legends.Helmet.Barbarian.unhold_helmet_heavy <- {
	ID = "barbarians/unhold_helmet_heavy", //400
	Script = "scripts/items/legend_helmets/helmets/legend_unhold_helmet_heavy",
	Sets = []
};
::Const.LegendMod.HelmObjs.push(::Legends.Helmet.Barbarian.unhold_helmet_heavy);

::Legends.Helmet.Barbarian.unhold_helmet_light <- {
	ID = "barbarians/unhold_helmet_light", //35
	Script = "scripts/items/legend_helmets/helmets/legend_unhold_helmet_light",
	Sets = []
};
::Const.LegendMod.HelmObjs.push(::Legends.Helmet.Barbarian.unhold_helmet_light);
