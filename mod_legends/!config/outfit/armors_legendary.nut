...
::Legends.Armor.Legendary.armor_of_davkul <- {
	ID = "legendary/armor_of_davkul", // 25-120 -4-18 130-1275
	Script = "",
	Sets = [{
		Cloth = [
...
::Legends.Armor.Legendary.legend_emperors_armor <- {
	ID = "legendary/legend_emperors_armor", // 70 -10 340
	Script = "",
	Sets = [{
		Cloth = [
...
::Legends.Armor.Legendary.legend_mountain_armor <- {
	ID = "legendary/legend_mountain_armor", // 70 -9 300
	Script = "",
	Sets = [{
		Cloth = [
...
::Legends.Armor.Legendary.legend_skin_armor <- {
	ID = "legendary/legend_skin_armor", // 20-65 -1-8 25-250
	Script = "",
	Sets = [{
		Cloth = [
			[5, "cloth/legend_armor_tunic", 4], // 20 -1 25
			[1, "cloth/legend_armor_gambeson", 2], // 65 -8 250
			[1, "cloth/legend_armor_quilted_aketon", 1], // 55 -6 150
		],
		Chain = [
