...
addNCSetting(config, ::MSU.Class.RangeSetting("DynamicDayToSkip", 30, 0, 150, 10, "Dynamic Troops Day To Skip", "Impacts how fast elite enemies start appearing on the map. If you leave it at 150 they will by default choose according to difficulty: 30 - Legendary, 60 Expert, 90 Veteran and 120 beginner."));
