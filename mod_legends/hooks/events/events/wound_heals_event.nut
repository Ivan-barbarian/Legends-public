::mods_hookExactClass("events/events/wound_heals_event", function(o) {
	...
	o.onUpdateScore = function () {
		...
		foreach( bro in brothers )
			if (bro.getBackground().getID() != ::Legends.Backgrounds.getID(::Legends.Background.Slave) && bro.getBackground().getID() != ::Legends.Backgrounds.getID(::Legends.Background.LegendDonkey) && bro.getSkills().hasSkillOfType(this.Const.SkillType.TemporaryInjury))
				candidates.push(bro);
