::mods_hookExactClass("events/events/creepy_guy_event", function (o) {
	...
	o.onUpdateScore = function () {
		...
		local candidates_shieldmaiden = ::World.getPlayerRoster().getAll().filter(@(idx, _bro) _bro.getBackground().getID() == ::Legends.Backgrounds.getID(::Legends.Background.LegendShieldmaiden));
		...
		local candidates_militia = ::World.getPlayerRoster().getAll().filter(@(idx, _bro) _bro.getBackground().getID() == ::Legends.Backgrounds.getID(::Legends.Background.Militia));
