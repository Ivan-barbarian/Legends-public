...
• Reduces the AP cost of [color=%skill%]Prong[/color] and [color=%skill%]Skewer[/color] by [color=%negative%]1[/color] and no longer has a penalty for attacking targets directly adjacent.
