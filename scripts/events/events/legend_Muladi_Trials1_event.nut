...
//Conditions:
//- Must have at least 1x Muladi bro.
//- Must be within 4 tiles of a southern city.
//- Event has not occurred in 15 days.
//- No brother must have the flags “MuladiTrials”, “MuladiTrials2”, or “MuladiTrials3”. (This means the event can only play once whilst you have the bro in question, but their death or leaving will allow the event to fire again.)

//Outcomes:
//- Muladi bro receives moderate damage AND one light blunt force temporary injury.
//- Muladi bro receives a moderate mood penalty.
//- Muladi loses -2 resolve and -2-4 health.
//- Muladi bro receives flag “MuladiTrials”



this.legend_Muladi_Trials1_event <- this.inherit("scripts/events/legends", {
  m = {
    Muladi = null,
  },
  function create() {
