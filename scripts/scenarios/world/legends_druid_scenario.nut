this.legends_druid_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	{
		if (bro.getBackground().getID() == ::Legends.Backgrounds.IDs.Wildman || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendHerbalist  || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendDruid  || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.Houndmaster  || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendMuladi  || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendConjurer  || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendEnchanter || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendRunesmith  || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendEntrancer  || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendDonkey  || bro.getBackground().getID() == ::Legends.Backgrounds.IDs.LegendSpiritualist)
		{
